...
public class Email {
    ...
    public static void main(String[] args) {
        ...
        String mailbody = "测试邮件发送成功！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！";//邮件正文
        email.setNeedAuth(true);
        email.setSubject("JAVA发邮件的测试");//邮件主题
        email.setBody(mailbody);//邮件正文
        email.setTo("1530231611@qq.com");//收件人地址
        email.setFrom("17797754554@163.com");//发件人地址
//        email.addFileAffix("C:\\Users\\lanling\\Desktop\\jquery-3.1.1.min.js");// 附件文件路径,例如：C:/222.jpg,*注；"/"的写法； 如果没有可以不写
